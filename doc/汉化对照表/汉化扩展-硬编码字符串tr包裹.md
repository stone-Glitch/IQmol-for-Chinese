...
> **当前主分支全量译文**：2111 条 / 153 个 context，0 unfinished、0 vanished（见 `translations/zh_CN.ts`）。
...
2. `translate_iqmol.py` 注入译文 → 1514 条全部 finished，0 unfinished。（注：此为第 2 阶段验证时数值；当前 HEAD 全量为 2111 条）
